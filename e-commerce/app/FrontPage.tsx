...
export default function FrontPage(): JSX.Element
{
	...
	return (
		<div className={`h-screen flex flex-col justify-between bg-no-repeat bg-cover bg-center`} style={{backgroundImage: `url(${bg_image})`}}>
			<MenuBar />
			<div className="text-white p-10 sm:p-20">
					<h1 className="text-5xl sm:text-7xl mb-10 font-bold">Let's Level Up Your Game</h1>
					<h2 className="text-2xl sm:w-200">Nam natoque in massa bibendum lacus, et arcu cursus nisl rutrum at tincidunt in sit in massa adipiscing lorem fusce.</h2>
				...
				<div className="flex justify-center">
					<FontAwesomeIcon className="text-center text-4xl mb-5 animate-bounce" icon={faAnglesDown} />
			</div>
		</div>
	);
}
